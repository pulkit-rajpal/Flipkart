...
public class ExcelToPojoUtils {
	...
	public static <T> List<T> toPojo(Class<T> type, InputStream inputStream) throws IOException, EncryptedDocumentException, InvalidFormatException {
		...
		for (int i = 0; i < headerRow.getPhysicalNumberOfCells(); i++) {
			Cell headerCell = headerRow.getCell(i, Row.RETURN_BLANK_AS_NULL);
